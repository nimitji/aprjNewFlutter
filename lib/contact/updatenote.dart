            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Container(padding: EdgeInsets.symmetric(horizontal: 10,vertical: 0.0),
                    height: MediaQuery.of(context).size.height*0.1,child:
                  Text("आपकी प्रोफाइल में कोई भी परिवर्तन या बदलाव हुआ है, अथवा आपको अपनी प्रोफाइल में कोई त्रुटि सुधार करवाना है तो यहाँ पर सारे बदलाव लिख कर हमे भेजे ",
                    textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                  ),
                  Container(padding: EdgeInsets.symmetric(horizontal: 10,vertical: 0.0),
                    height: MediaQuery.of(context).size.height*0.1,child:
                  Text("If your profile has changed or you want to update any information or any correction is needed, \nthen please send us ",
                    textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                  ),
                  ...
                  Container(
                      ...
                      child:Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Container(
                            child: Text(
                                "आपकी प्रोफाइल की ID डाले (Profile ID)",textAlign: TextAlign.center,
                                      ...
                                      onPressed: () async {
                                        ...
                                        setState(() {
                                          ...
                                          if(Name=="Could not fetch the data")
                                            ...
                                            name=Name+" की प्रोफाइल में अपडेट करना है";
              ...
              Container(height: 50,
                  child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        PersonalProfilewithc newprofile=new PersonalProfilewithc(
                          Sno:_Sno.text
                        );
                        ...
                        if(result=="200")
                        {
                          getdialog("200","धन्यवाद","आपकी रिक्वेस्ट हमारे सिस्टम में ऐड कर ली गई है, जिसपर जल्दी कार्यवाही होगी ");
                          setState(() {
                            issaving=false;
                          });
                        }
                        else{
                          getdialog(result.toString(),"कार्य पूरा नहीं हुआ ","तकनिकी वजह से आपकी रिक्वेस्ट ऐड नहीं हुई है");
                          setState(() {
                            issaving=false;
                          });
