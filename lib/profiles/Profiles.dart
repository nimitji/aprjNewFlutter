            ...
            children: [
              Stack(
                children: [
                  Obx(()=>Column(
                    children: [
                      Transform.translate(offset: Offset(0.0,70),
                        child:     SizedBox(
                            ...
                            itemBuilder: (ctx, index) {
                              return Container(
                                child: ListTile(
                                  ...
                                  leading:_profile.Nselected[index].PhotoLink1!="NA"?Image(image: NetworkImage(_profile.Nselected[index].PhotoLink1!)):
                                  Image(image: AssetImage("image/na.jpg")
                                  ),
                                  title:getageondate(_profile.Nselected[index]),
                                  subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      _profile.Nselected[index].Gender=="M"?Text("(सुपुत्र "+_profile.Nselected[index].Mother!+" एवं "+_profile.Nselected[index].Father!+")")
                                          :Text("(सुपुत्री "+_profile.Nselected[index].Mother!+" एवं "+_profile.Nselected[index].Father!+")"),
                                      Row(
                                        children: [
                                          Text(_profile.Nselected[index].BirthPlace!),
                                          Text("/"),
                                          _profile.Nselected[index].ContactInfoobj!=null?Text(_profile.Nselected[index].ContactInfoobj!.City!):Text("NA"),
                                        ],
                                      ),
                                    ],
                                  ),
                                  ...
                                  onTap: ()async{
                                    ...
                                    await _profile.getindividualprofiles(id:_profile.Nselected[index].id);
                  ...
                  Obx(()=>ExpansionTile(
                    ...
                    title: Text("फ़िल्टर द्वारा ढूंढ़ने के लिए यहाँ दबाएं ",style:
                    TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                    leading:Icon(Icons.filter_alt),
                    trailing: Icon(Icons.arrow_drop_down_circle,size: 40,color:Colors.grey),
...
class Profiles extends StatefulWidget {
  ...
  @override
  _ProfilesState createState() => _ProfilesState(manglikstatus, gender,
      title);
}
     ...
     switch(index){
       case 1:
         fileredprofiles=profiles!.where((profiles)=>
             ...
             profiles.Profession!.toLowerCase().contains("medical")||
             profiles.Designation!.toLowerCase().contains("doctor")||
                 profiles.Designation!.toLowerCase().contains("medical")||
                 profiles.Designation!.toLowerCase().contains("md")||
                 profiles.Designation!.toLowerCase().contains("dentist")||
                 profiles.Qualification!.toLowerCase().contains("mbbs")||
                 profiles.Qualification!.toLowerCase().contains("pharma")||
                 profiles.Qualification!.toLowerCase().contains("bhms")||
                 profiles.Qualification!.toLowerCase().contains("bds")
         ).toList();
         break;
       case 5:
         fileredprofiles=profiles!.where((profiles)=>
             profiles.Profession!.toLowerCase().contains("engineer")||
                 profiles.Qualification!.toLowerCase().contains("engineer")||
                 profiles.Qualification!.toLowerCase().endsWith("tech")
         ).toList();
         break;
       case 2:
         fileredprofiles=profiles!.where((profiles)=>
             profiles.Qualification!.toLowerCase().startsWith("ca")||
                 profiles.Qualification!.toLowerCase().startsWith("cs")||
       ...
       case 4:
         fileredprofiles=profiles!.where((profiles)=>
             profiles.Designation!.toLowerCase().contains("teacher")||
                 profiles.Designation!.toLowerCase().contains("lecturer")||
                 profiles.Designation!.toLowerCase().contains("professor")||
                 profiles.Designation!.toLowerCase().contains("tution")||
                 profiles.Designation!.toLowerCase().contains("coaching")||
                 profiles.Designation!.toLowerCase().contains("instructor")||
                 profiles.Qualification!.toLowerCase().endsWith("ed")||
                 profiles.Profession!.toLowerCase().contains("teacher")||
                 profiles.Profession!.toLowerCase().contains("lecturer")||
       ...
       case 13:
         print(tAge!+" "+FAge!);
         fileredprofiles=profiles!.where((profiles)=>int.parse(profiles.Age!)>=int.parse(FAge!)
       ...
       case 8:
         ...
         profiles.Qualification!.toLowerCase().endsWith('it')||
             profiles.Qualification!.toLowerCase().contains("software")||
             profiles.Qualification!.toLowerCase().contains("bca")||
             profiles.Qualification!.toLowerCase().contains("mca")||
             profiles.Profession!.toLowerCase().contains("software")||
             profiles.Profession!.toLowerCase().contains("it")||
             profiles.Profession!.toLowerCase().contains("hardware")||
       ...
       case 10:
         fileredprofiles=profiles!.where((profiles)=>
         profiles.Profession!.toLowerCase().contains("startup")||
             profiles.Profession!.toLowerCase().contains("entrepreneur")
         ).toList();
         break;
       case 11:
         fileredprofiles=profiles!.where((profiles)=>
         profiles.Profession!.toLowerCase().contains("law")||
             ...
             profiles.Qualification!.toLowerCase().contains("advisor")||
             profiles.Profession!.toLowerCase().startsWith("advocate")||
                              ...
                              SizedBox(height: 30,),*/
                                Container(width: 220,
                                  ...
                                  child:DropdownButton<String>(
                                    ...
                                    items:<String>["NA",
                                      "अहमदाबाद",  "सूरत",  "अशोकनगर",  "आगरा",  "अकाझिरी",  "अम्बाह",  "अजमेर",  "भोपाल",  "वंडील",  "धौलपुर",  "डबरा",  "दिल्ली",  "ईसागढ़",  "फ़िरोज़ाबाद",  "गुना",
                                      "इंदौर",  "उज्जैन",  "झाँसी",  "कोटा",  "जयपुर",  "कस्बाथाना",  "करैरा",  "कोलारस",  "कांकरोली",  "किसनगढ़",  "कोलकाता",  "मुरैना",  "मनियां",  "मकराना",  "मुंबई",
                                      "मुरार",  "ग्वालियर",  "गोहद",  "पोहरी",  "नरवर",  "राजाखेड़ा",  "रन्नौद",  "शिवपुरी",  "बड़ोदरा","बंगलोर","पुणे","गुरुग्राम","ग़ाज़ियाबाद",
                                      "नॉएडा"
              ...
              children: [
                Container(width: 110,
                  child: ElevatedButton(onPressed:(){
                    ...
                    child: Text("Engineer",style: TextStyle(color: Colors.white),),
                    style:ButtonStyle(
                      backgroundColor: MaterialStateProperty.all<Color>(Colors.purple),
                      shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                        RoundedRectangleBorder(
                ...
                Container(width: 110,
                  child: ElevatedButton(onPressed:(){
                    ...
                    child: Text("Govt Job",style: TextStyle(color: Colors.white),),
                    style:ButtonStyle(
                ...
                Container(width: 110,
                  child: ElevatedButton(onPressed:(){
                    ...
                    child: Text("Private Job",style: TextStyle(color: Colors.white),),
                    style:ButtonStyle(
              ...
              children: [
                ...
                Container(width: 110,
                  child: ElevatedButton(onPressed:(){
                    ...
                    child: Text("Pursuing",style: TextStyle(color: Colors.white),),
                    style:ButtonStyle(
