                            ...
                            if (flag == 0) {
                              fileredprofiles =
                                  profiles
                                      .where(
                                        (profiles) =>
                                            profiles.Name!.startsWith(value),
                                      )
                                      .toList();
                              selected = false;
                            } else {
                          ...
                          setState(() {
                            fileredprofiles =
                                profiles
                                    .where(
                                      (profiles) =>
                                          profiles.Father!.startsWith(value),
                                    )
                                    .toList();
                        ...
                        setState(() {
                          if (flag == 0) {
                            ...
                            fileredprofiles =
                                profiles
                                    .where(
                                      (profiles) => profiles.Qualification!
                                          .startsWith(newValue!),
                                    )
                                    .toList();
                            selected = false;
    ...
    if (mamagotraddvalue == "NA") {
      ...
      setState(() {
        fileredprofiles =
            widget.profiles
                .where(
                  (profiles) => profiles.GotraMother!.toLowerCase().contains(
                    value.toLowerCase(),
                  ),
                )
                .toList();
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          SizedBox(height: 60),
          Column(children: [_setState(fileredprofiles)]),
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) => Search3(
                                ...
                                widget.gender,
                                widget.selfddvalue,
                                getgotraninenglish(mamagotraddvalue),
                                widget.titie,
                              ),
                        ),
                      );
    ...
    if (qualification == "NA") {
      ...
      setState(() {
        fileredprofiles =
            widget.profiles
                .where(
                  (profiles) => profiles.Qualification!.toLowerCase().contains(
                    value.toLowerCase(),
                  ),
                )
                .toList();
    ...
    if (profession == "NA") {
      ...
      setState(() {
        fileredprofiles =
            widget.profiles
                .where(
                  (profiles) => profiles.Profession!.toLowerCase().contains(
                    value.toLowerCase(),
                  ),
                )
                .toList();
  ...
  _setState(data) {
    return (Text(
      widget.titie! +
          ...
          " \nमें कुल प्रोफाइल जिनकी Profession " +
          profession! +
          " है : " +
          fileredprofiles.length.toString(),
      style: TextStyle(color: Colors.white, fontSize: 25),
            ...
            _profile.searchedprofile.value.PhotoLink1 != null
                ? Container(
                  child: ListTile(
                    ...
                    leading:
                        _profile.searchedprofile.value.PhotoLink1 != "NA"
                            ? Image(
                              image: NetworkImage(
                                _profile.searchedprofile.value.PhotoLink1!,
                              ),
                            )
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        _profile.searchedprofile.value.Gender == "M"
                            ? Text(
                              "(सुपुत्र " +
                                  _profile.searchedprofile.value.Mother! +
                                  " एवं " +
                                  _profile.searchedprofile.value.Father! +
                                  ")",
                            )
                            : Text(
                              "(सुपुत्री " +
                    ...
                    onTap: () async {
                      ...
                      await _profile.getindividualprofiles(
                        id: _profile.searchedprofile.value.id,
                      );
                    },
                  ),
                )
