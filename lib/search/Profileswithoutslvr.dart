...
class FilteredProfileList extends StatelessWidget {
  final String? gender,mstatus;
  final List<PersonalProfilewithc>? personalprofiles;


  const FilteredProfileList({Key? key, this.personalprofiles, this.gender, this.mstatus}) : super(key: key);
  ...
  getlist() {
    ...
    return ListView.builder(
        itemCount: personalprofiles!.length,
...
class FilteredProfiles extends StatefulWidget {
  final List<PersonalProfilewithc> personalProfilewithc;
 final String? title;
  FilteredProfiles(this.personalProfilewithc,this.title);

  @override
  _FilteredProfilesState createState() => _FilteredProfilesState();
}

class _FilteredProfilesState extends State<FilteredProfiles> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("फिल्टर्स से चुनी प्रोफाइल ")
      ),
      ...
      Stack(
        ...
        children: [
          ...
          FilteredProfileList(personalprofiles:widget.personalProfilewithc),
